...
// Greet the world with the class first program
void CppVariation::HelloWorld()
{
	printf("Hello, World!\n");
}

// Print the lyrics to "99 Bottles of Beer on the Wall" to the screen
int CppVariation::_99Bottles()
{
	int bottleCount = 99;
...
void CppVariation::DrawWordLengthChart(char* filePath)
{
